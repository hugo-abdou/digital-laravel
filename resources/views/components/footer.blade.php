<div class="relative w-full ">
    <img src="/assets/footer overlay.png" alt="Rectangle photo"
    ...
    <div class="relative flex flex-wrap py-10 text-white container mx-auto px-9">
            ...
            <ul class="mt-5 space-y-3 w-full">
                <li class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <span class="block text-sm font-bold text-gray-lv-2">+212 666 888 000</span>
                    </div>
                </li>
                <li class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <span class="block text-sm font-bold text-gray-lv-2">example@email.com</span>
                    </div>
                </li>
                <li class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <span class="block text-sm font-bold text-gray-lv-2">80 Broklyn Street</span>
                    </div>
                </li>
            </ul>
        </div>
        <div class="w-full lg:w-2/4 flex lg:justify-center mt-10 lg:m-0">
            ...
            <div>
                <span class="text-p-sm">Challenges</span>
                <ul class="mt-5 space-y-3">
